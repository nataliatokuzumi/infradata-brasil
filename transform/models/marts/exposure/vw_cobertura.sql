-- Q9: última atualização por UF/tipo e lacunas. "Lacuna" é relativo às UFs
-- pares, não a um calendário oficial do DNIT (não é uma fonte disponível
-- aqui) — periodos_esperados é qualquer (tipo, período) em que pelo menos
-- uma UF de fato publicou.
with periodos as (
