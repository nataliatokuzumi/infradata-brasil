...
from sources.sicro.scrape_links import scrape_all_regions
...
class SicroClient(SicroTrackingDatabase):

    def __init__(self):
        super().__init__(db_path=database_local_path)
    ...
    def process_pending_downloads(self, nfiles=None, max_workers=5):
        ...
        logger.info(f"Found {len(pending_rows)} pending downloads in the database.")
